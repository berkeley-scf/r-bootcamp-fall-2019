...
All of these are important to *truly* becoming a `ggplot2` master `r emo::ji("wizard")` `r emo::ji("wink")`, but today we are going to focus on the most important to basic users and their data layers: `ggplot2`'s *geometries*
