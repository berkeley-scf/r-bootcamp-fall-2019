...
The GitHub site ([https://github.com/berkeley-scf/r-bootcamp-fall-2019](https://github.com/berkeley-scf/r-bootcamp-fall-2019)) is the main site for the bootcamp. It has information on logistics, software installation, and is the master repository for materials for the modules.

We'll use the r-bootcamp-fall-2019@lists.berkeley.edu [Google group](https://groups.google.com/a/lists.berkeley.edu/d/forum/r-bootcamp-fall-2019) for discussion and answering questions during (and before) the bootcamp. 
...
Counselors will be available to help answer any questions you have (just wave to one of them), or feel free to just ask the presenter during the presentation. The counselors will also be monitoring the [Google group Q&A area](https://groups.google.com/a/lists.berkeley.edu/d/forum/r-bootcamp-fall-2019), so feel free to type in a question there (or send email to r-bootcamp-fall-2019@lists.berkeley.edu) and one of the counselors will answer the question. Or if you know the answer, help us out by answering it yourself or adding your thoughts. 
...
- "Repository URL": https://github.com/berkeley-scf/r-bootcamp-fall-2019
- "Project Directory Name": r-bootcamp-fall-2019 (or something else of your choosing)
...
- `git clone https://github.com/berkeley-scf/r-bootcamp-fall-2019`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/r-bootcamp-fall-2019`
- `git pull`

## As a zip file

If you don't want to bother using Git or have problems, simply download a zip file with all the material from [https://github.com/berkeley-scf/r-bootcamp-fall-2019/archive/master.zip](https://github.com/berkeley-scf/r-bootcamp-fall-2019/archive/master.zip).
